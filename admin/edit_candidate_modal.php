                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                           ...
                                           <input type="file" name="image"required> 
												 ...
												 <button name = "update" type="reset" class="btn btn-success">Cancel All</button>
										...
										{
										mysql_query ("UPDATE candidate SET position = '$position', firstname = '$firstname', lastname = '$lastname', year_level = '$year_level', 
										gender = '$gender',img='$location' WHERE candidate_id = '$candidate_id'")or die(mysql_error());
										}
