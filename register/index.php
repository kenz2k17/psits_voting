    ...
    <div id="wrapper">
       ...
       <?php include ('side_bar.php');?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Registration for PSITS Students</h3>
                </div>
				<div class = "well col-lg-5">
                        ...
                        <div class="panel-body">
                         <form method = "post" enctype = "multipart/form-data">	
							  ...
							  <?php include ('dbcon.php');
								...
								$query = mysql_query("select * from voters where id_number='$id_number'") or die (mysql_error());
								$count = mysql_num_rows($query);
									...
									<?php
										...
										mysql_query("insert into voters(id_number, password, firstname,lastname,year_level,status) VALUES('$id_number', '$password','$firstname','$lastname','$year_level','Unvoted')");
									?>
									<script>
					...
					<div class = "col-lg-5">	
						<img src = "chmsc.png" style = "height:300px; width:300px; margin-left:59px; margin-top:80px; " />
					</div>
